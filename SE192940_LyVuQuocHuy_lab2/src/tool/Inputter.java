...
public class Inputter {
    ...
    public Date inputDate(String msg, String errorMsg, boolean mustBeFuture) {    
        ...
        do {            
            try {
                Date date = sdf.parse(getString(msg).trim());
    ...
    public Guest inputGuest(boolean isUpdated, Guest oldGuest, RoomManager roomManager, GuestManager guestManager) {
        ...
        do {
            if (isUpdated) {
                System.out.print(mess + "[" + oldGuest.getPhoneNumber() + "]: ");
                String phone = getString("").trim();
                if(phone.isEmpty()){
                    guest.setPhoneNumber(oldGuest.getPhoneNumber());
                    more = true;
                }else if(Validator.isValid(phone, regex)){
        ...
        do {
            if (isUpdated) {
                System.out.print(mess + "[" + oldGuest.getRentalDays() + "]: ");
                String number = getString("").trim();
                if (number.isEmpty()) {
        ...
        String cotenantName;
        if (isUpdated) {
            System.out.print(mess+"["+oldGuest.getCoTenantName()+"]: ");
